...
#found this one very challenging and used solution to understand

class HTMLTag
  #font hashes created with the keys and values
  ...
  #color hashes created with the keys and values
  COLORS = {
  ...
  #add color and multiline as getters and setters to the class HTMLTag
  ...
  #no longer needed below as font options added to the initialize
  #def font
